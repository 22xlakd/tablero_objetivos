...
class RegistrosControllerTest < ActionController::TestCase
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post :create, registro: { fecha: @registro.fecha, sucursal_id: @registro.sucursal_id, value: @registro.value, variable_id: @registro.variable_id }
    end
  ...
  test "should update registro" do
    patch :update, id: @registro, registro: { fecha: @registro.fecha, sucursal_id: @registro.sucursal_id, value: @registro.value, variable_id: @registro.variable_id }
    assert_redirected_to registro_path(assigns(:registro))
  end
